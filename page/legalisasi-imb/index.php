        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h2>Surat Legalisasi Permohonan Izin Mendirikan Bangunan</h2>
                    <ol>
                        <li><a href="<?= base_url('dashboard'); ?>">Home</a></li>
                        <li>Legalisasi Izin Mendirikan Bangunan</li>
                    </ol>
                </div>
        ...
        <section id="services" class="services graform">
            <div class="container-fluid">
                ...
                <div class="section-title">
                    <h2>Informasi Surat Legalisasi Permohonan Izin Mendirikan Bangunan</h2>
                    <!-- <p>Daftar Pemohon</p> -->
                </div>
