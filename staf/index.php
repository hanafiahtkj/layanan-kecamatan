          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('staf/sktu/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('staf/iumk/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('staf/ahli-waris/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('staf/rpp/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('staf/legalisasi-imb/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('staf/legalisasi-proposal/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('staf/legalisasi-izin-tower/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
