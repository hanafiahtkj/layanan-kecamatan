...
<body class="hold-transition sidebar-mini sidebar-collapse">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Edit Surat Rekomendasi Pendirian PAUD</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <form class="form-horizontal" method="POST" action="">
                                    <div class="card-body" style="background-color: azure;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="nama_pendiri" name="nama_pendiri" required value="<?= $row['nama_pendiri'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="nama_sekolah" name="nama_sekolah" required value="<?= $row['nama_sekolah'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="alamat_sekolah" id="alamat_sekolah" rows="3" class="form-control" required><?= $row['alamat_sekolah'] ?></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer" style="background-color: white;">
                                        <a href="<?= base_url('staf/rpp') ?>" class="btn bg-gradient-secondary float-right"><i class="fa fa-arrow-left"> Batal</i></a>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($status == "Selesai") {
            ...
            $submit = $koneksi->query("UPDATE rekomendasi_pendirian_paud SET 
        ...
        if ($submit) {
            $_SESSION['pesan'] = "Data Surat Rekomendasi Pendirian PAUD Diubah";
