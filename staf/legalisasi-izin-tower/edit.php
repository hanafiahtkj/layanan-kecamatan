...
$data = $koneksi->query("SELECT * FROM legalisasi_izin_tower WHERE id_izin_tower = '$id'");
...
<body class="hold-transition sidebar-mini sidebar-collapse">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-7">
                            <h1 class="m-0 text-dark">Edit Legalisasi Permohonan Izin Tower</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-5">
                                ...
                                <form class="form-horizontal" method="POST" action="">
                                    <div class="card-body" style="background-color: azure;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="alamat_perusahaan" id="alamat_perusahaan" rows="3" class="form-control" required><?= $row['nama_perusahaan']; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="lokasi_tower" id="lokasi_tower" rows="3" class="form-control" required><?= $row['lokasi_tower']; ?></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer" style="background-color: white;">
                                        <a href="<?= base_url('staf/legalisasi-izin-tower') ?>" class="btn bg-gradient-secondary float-right"><i class="fa fa-arrow-left"> Batal</i></a>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($status == "Selesai") {
            ...
            $submit = $koneksi->query("UPDATE legalisasi_izin_tower SET 
        ...
        if ($submit) {
            $_SESSION['pesan'] = "Data Legalisasi Permohonan Izin Tower Diubah";
