                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    <?php
                                    $n_sktubaru = $koneksi->query("SELECT * FROM sktu_baru WHERE status = 'Dalam Proses' AND id_posisi = 2");
                                    ...
                                    ?>
                                        <a href="<?= base_url('sekcam/sktu/baru/detail?id= ' . encryptor('encrypt', $r['id_sktu'])); ?>">
                        ...
                        <div class="col-md-4">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    <?php
                                    $n_sktuppj  = $koneksi->query("SELECT * FROM sktu_perpanjangan WHERE status = 'Dalam Proses' AND id_posisi = 2");
                                    ...
                                    ?>
                                        <a href="<?= base_url('sekcam/sktu/perpanjangan/detail?id= ' . encryptor('encrypt', $r['id_sktu'])); ?>">
                                            <div class="callout callout-danger">
                                                <h5><?= $r['nama_pemohon']; ?>
                                                    <span class="float-right text-mute"><small><?= $dt; ?></small></span>
                                                </h5>
                        ...
                        <div class="col-md-4">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                        <a href="<?= base_url('sekcam/iumk/detail?id= ' . encryptor('encrypt', $r['id_iumk'])); ?>">
                                            <div class="callout callout-danger">
                                                <h5><?= $r['nama_pemohon']; ?>
                                                    <span class="float-right text-mute"><small><?= $dt; ?></small></span>
                                                </h5>
