          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('admin/pelayanan/iumk/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('admin/pelayanan/ahli-waris/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
