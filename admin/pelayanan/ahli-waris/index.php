        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Data Surat Pernyataan Ahli Waris</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item">Pelayanan</li>
                                <li class="breadcrumb-item active">Surat Pernyataan Ahli Waris</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                                        ...
                                                        <td width="15%">
                                                            ...
                                                            ?>
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="status?id=<?= encryptor('encrypt', $row['id_ahli_waris']) ?>&s=Belum Diproses">Belum Diproses</a>
                                                                    <a class="dropdown-item" href="status?id=<?= encryptor('encrypt', $row['id_ahli_waris']) ?>&s=Dalam Proses">Dalam Proses</a>
                                                            ...
                                                            <a href="hapus?id=<?= encryptor('encrypt', $row['id_ahli_waris']); ?>" class="btn bg-gradient-danger btn-sm alert-hapus" data-id="<?= $row['nama_almarhum'] ?>" title="Hapus"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
