                                                        ...
                                                        <td width="15%">
                                                            ...
                                                            ?>
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="status?id=<?= encryptor('encrypt', $row['id_rpp']) ?>&s=Belum Diproses">Belum Diproses</a>
                                                                    <a class="dropdown-item" href="status?id=<?= encryptor('encrypt', $row['id_rpp']) ?>&s=Dalam Proses">Dalam Proses</a>
                                                                    <a class="dropdown-item alert-status" href="status?id=<?= encryptor('encrypt', $row['id_rpp']) ?>&s=Selesai">Selesai</a>
                                                                </div>
                                                            ...
                                                            <a href="edit?id=<?= encryptor('encrypt', $row['id_rpp']); ?>" class="btn bg-gradient-success btn-sm" title="Edit"><i class="fa fa-edit"></i></a>

                                                            <a href="hapus?id=<?= encryptor('encrypt', $row['id_rpp']); ?>" class="btn bg-gradient-danger btn-sm alert-hapus" data-id="<?= $row['nama_pendiri'] ?>" title="Hapus"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
