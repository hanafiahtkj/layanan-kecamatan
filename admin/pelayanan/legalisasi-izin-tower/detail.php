        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-7">
                            <h1 class="m-0 text-dark">Detail Legalisasi Permohonan Izin Tower</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-5">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item">Pelayanan</li>
                                <li class="breadcrumb-item">Legalisasi Permohonan Tower</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <a href="<?= base_url('admin/pelayanan/legalisasi-izin-tower') ?>" class="btn bg-gradient-gray float-right"><i class="fa fa-arrow-left"> Kembali</i></a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                <th width="30%">Lokasi Tower</th>
                                                <td width="2%">:</td>
                                                <td><?= $row['lokasi_tower'] ?></td>
                                            </tr>
                                            <tr>
