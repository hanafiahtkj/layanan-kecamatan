        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Verifikasi Surat Keterangan Tempat Usaha</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools">
                                            <a href="<?= base_url('kasi/sktu/baru/detail?id=' . encryptor('encrypt', $row['id_sktu'])) ?>" class="btn bg-gradient-danger btn-tool"><i class="fa fa-arrow-left"> Kembali</i></a>
                                        </div>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
