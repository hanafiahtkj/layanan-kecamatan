...
<body class="hold-transition sidebar-mini sidebar-collapse">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Tambah Legalisasi Permohonan IMB</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <form class="form-horizontal" method="POST" action="">
                                    <div class="card-body" style="background-color: azure;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="lokasi_bangunan" id="lokasi_bangunan" rows="3" class="form-control" required></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer" style="background-color: white;">
                                        <a href="<?= base_url('kasi/legalisasi-imb') ?>" class="btn bg-gradient-secondary float-right"><i class="fa fa-arrow-left"> Batal</i></a>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($status == "Selesai") {
            ...
            $submit = $koneksi->query("INSERT INTO legalisasi_imb VALUES (null, '$tgl_permohonan', '$kelurahan', '$nama_pemohon', '$alamat_pemohon', '$lokasi_bangunan', '$keterangan', '$tgl_selesai', 4, '$status')");
        } else {
            $submit = $koneksi->query("INSERT INTO legalisasi_imb VALUES (null, '$tgl_permohonan', '$kelurahan', '$nama_pemohon', '$alamat_pemohon', '$lokasi_bangunan', '$keterangan', null, '$id_posisi', '$status')");
        }

        if ($submit) {
            $_SESSION['pesan'] = "Data Legalisasi Permohonan Izin Mendirikan Bangunan Ditambahkan";
