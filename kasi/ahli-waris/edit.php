        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Edit Surat Pernyataan Ahli Waris</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <form class="form-horizontal" method="POST" action="">
                                    <div class="card-body" style="background-color: azure;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="nama_almarhum" name="nama_almarhum" required value="<?= $row['nama_almarhum']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="nama_ahli_waris" name="nama_ahli_waris" required value="<?= $row['nama_ahli_waris']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" id="tgl_meninggal" name="tgl_meninggal" required value="<?= $row['tgl_meninggal']; ?>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer" style="background-color: white;">
                                        <a href="<?= base_url('kasi/ahli-waris') ?>" class="btn bg-gradient-secondary float-right"><i class="fa fa-arrow-left"> Batal</i></a>
