                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <?php if ($row['status'] == "Dalam Proses" and $row['id_posisi'] == 3) : ?>
                                        ...
                                        <?php endif ?>
                                        <a href="<?= base_url('camat/sktu') ?>" class="btn bg-gradient-secondary btn-tool"><i class="fa fa-arrow-left"> Kembali</i></a>
                                    </div>
                                </div>
