...
<body>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="nama-lengkap" class="form-control" name="nama" placeholder="Nama Lengkap" required maxlength="50">
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var token = parsedResult.key;

            $('#nama-lengkap').val(user.name);
            ...
            <script type='text/javascript'>
                ...
                if ($isValid)
                {
                    ...
                    if(!$cekSso)
                    {
                        ...
                        $cekNik = $koneksi->query("SELECT * FROM masyarakat WHERE nik = '$nik'")->fetch_array();

                        if(!$cekNik) 
                        {
                            $submit = $koneksi->query("INSERT INTO masyarakat VALUES (null, '$nama', '$nik', '$tempat_lahir', '$tgl_lahir', '$jk', '$agama', '$telpon', '$email', '$alamat', '$no_rumah', '$rt', '$rw', '$kelurahan', '$pass_hash', '$id_sso')");
                        }
                        else {
                            $submit = $koneksi->query("UPDATE masyarakat SET id_sso = ".$id_sso." where id_masyarakat ='$cekNik[id_masyarakat]'");
                        }
                    }
